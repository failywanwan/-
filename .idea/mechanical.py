...
def aripartspage():
    ...
    for i in range(1,340):
        baseurl="https://www.godirecttrade.com/mechanical.html"
        pageurl="?p="+str(i)
        url=baseurl+pageurl
        driver.get(url)
...
def export_excel(dic_data):
    ...
    # 指定生成的Excel表格名称
    file_path=pd.ExcelWriter('Mechanical.xlsx')
...
def test():
    airparts=[]
    url="https://www.godirecttrade.com/honeywellaerospacetradingusa-pn-3505920-9-sn-153ca.html"
    driver.get(url)
    #1
    try:
        sku=driver.find_element_by_xpath('//*[@id="maincontent"]/div[2]/div/div[1]/div/div/div[1]/div[1]/div/div[2]/div/div[2]/div/div/div[1]/div[2]/h1').text
